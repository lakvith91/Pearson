<%-- 
    Document   : index
    Created on : Nov 10, 2014, 7:57:54 PM
    Author     : Lakshan
--%>
                    ...
                    <div class="thumbnail " >
                        ...
                        <div class="table-responsive marginedit">
                            ...
                            <table class="table table-bordered tableStyle" >
                                ...
                                <tbody>
                                    <%
                                        DataCon dacon = DataCon.getDbCon();// setup the database connection

                                        DBCursor dbcurser = dacon.getData();
                                        ...
                                        while (dbcurser.hasNext()) {
                                            ...
                                            tableInner += "<tr>";
                                            tableInner += "<td>" + dBObject.get("Bulk_ID") + "</td>";
                                            ...
                                            tableInner += "<td>" + dBObject.get("Status") + "</td>";
