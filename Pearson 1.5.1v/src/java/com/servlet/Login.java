...
public class Login extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       // redirct to index if username and password are empty
        ...
        }if((login.getUsername().trim()).equalsIgnoreCase("admin")&&login.getPassword().trim().equalsIgnoreCase("admin")) {
        
                 HttpSession session = request.getSession(true);	    
                 //Employee e=new Employee();
                 //e.setfName("Admin");
                 session.setAttribute("user","Admin"); // create session for user
