           ...
           <!--      <div class="thumbnail marginedit thambaline_inner" style="background-image:url('images/background.png');background-repeat:no-repeat;"> <!--Inside thumbanil--> 
                 ...
                 <form  action="AddClaim" class="form-control-static marginedit" name="myClaimForm" method="post" ><!--Start point of form-->
                 	...
                 	<table style="width: 100%;margin-left:100px;"><!--Start point of table-->
						...
						<tr> 
							<td>&nbsp;
			                	<div style="width:50%;"><!-- row number 1 col 1--> 
			                		<label id="bulk_id" class="label labelstyle">Bulk ID:</label><br>
                                                        <label id="bulk_id" class="label labelstyle"><b>001</b></label>
			                		<!--<input id="Bulk_ID" name="Bulk_ID" class="form-control input-lg" type="text" placeholder="Bulk ID">-->
								</div>
							</td>-->
							...
							<td>&nbsp;
								<div style="width:50%;" >	<!-- row number 2 col 2-->
									...
									<input  id="project" name="project" class="form-control input-lg" type="text" placeholder="Project" >
								</div>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td>&nbsp;
			                	<div style="width:50%;"><!-- row number 2 col 1-->
			                		<label id="claim_id" class="label labelstyle">Claim ID:</label>
			                		<input id="claim_id" name="claim_id" class="form-control input-lg" type="text" placeholder="Claim ID" >
								</div>
							</td>
							<td>&nbsp;
								<div style="width:50%;" >	<!-- row number 2 col 2-->
									<label id="type_of_claim" class="label labelstyle">Type of Claim:</label>
									<select id="type_of_claim" name="type_of_claim" class="form-control input-lg" placeholder="Claim Type" style="height:37px;">
						...
						<tr>
							<td>&nbsp;
			                	<div style="width:50%;"><!-- row number 3 col 1-->
			                		...
			                		<input id="bill_date" name="bill_date" class="form-control input-lg" type="text" placeholder="Bill Date">
								</div>
							</td>
							<td>&nbsp;
						...
						<tr>
							<td>&nbsp;
			                	<div style="width:50%;"><!-- row number 4 col 1-->
			                		<label id="event_date" class="label labelstyle">Event Date:</label>
			                		<input id="event_date" name="event_date" class="form-control input-lg" type="text" placeholder="Event Date">
								</div>
							</td>
							<td>&nbsp;
							<div style="width:50%;">	<!-- row number 4 col 2-->
							
									<label id="attachment" class="label labelstyle">Attachment:</label>

									<input id="attachment" name="attachment" class="form-control input-lg" type="file"  onchange="show_pic(this)" placeholder="Attachment" >
						...
						<tr >
						<td>&nbsp;
							<div style="width:100%;"><!-- row number 5 col 1-->
						...
						<td>&nbsp;
							<div style="width:50%;"><!-- row number 5 col 2-->
								...
								<button type="submit" class="btn btn-danger active button pull-right " style="width:50%;margin-top:10px;"  ><!--Add button -->
				...
				<div class="table-responsive marginedit">
						...
						<thead align="center" >
							<tr>
								...
								<td>&nbsp;Project</td>
								<td>&nbsp;Amount</td>
								<td>&nbsp;Attachment</td><td>&nbsp;Edit/Delete </td>
								<td>&nbsp;Status</td>
