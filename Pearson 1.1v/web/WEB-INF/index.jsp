                            	...
                            	<div class="row"><!-- First row start -->
									<div class="col-md-1"></div>
                   					<div class="col-md-3 margin_sign_up">
	                    		 			<div class="label" style="color:black;">User Name&nbsp;:</div>
	                    		 		</div>
	                    		 		<div class="col-md-7">
                    		...
                    		<div class="col-md-6"> <!-- Start of main two coloumn left-->
                    				...
                    				<div class="row"  style="margin-top:20px;"><!-- Forth row start on left-->
                    					...
                    					<div class="col-md-4 margin_sign_up">
	                    		 		...
	                    		 		<div class="col-md-7">
	                    		 			<div class="form-group">
	                                        	<input name="fname"type="text" class="form-control input-lg" placeholder="Employee ID*">
	                                    	</div>
	                                    </div>
									</div><!-- Forth row end -->
                     		...
                     		<div class="col-md-6"><!-- Start of main two coloumn Right-->
                    				...
                    				<div class="row"><!-- First row Start on right -->
                    					...
                    					<div class="col-md-4 margin_sign_up">
	                    		 		...
	                    		 		<div class="col-md-7">
	                    		 			<div class="form-group">
	                                        	<input name="fname"type="text" class="form-control input-lg" placeholder="Last Name*">
	                                    	</div>
	                                    </div>
									</div><!-- First row end -->
