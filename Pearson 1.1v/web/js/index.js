...
/*
  var dbcon=new DBCon();
      dbcon.getDbCon();
  var cursor=dbcon.getData("Employee");
   
   var d=new BasicDBObject("empid",1234);
   var p=(String)(d.get("password"));
 */  
...
/*   
  while (cursor.hasNext()) {
           var dbo = cursor.next();
           var c=Claims.fromDBObject(dbo); 
           var id=Integer.toString(c.getEmpId());
           var ps=(String)(c.getPassword());
     if (username == id && password == ps ){
