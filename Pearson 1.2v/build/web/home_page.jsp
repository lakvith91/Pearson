...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse pull-right" id="bs-example-navbar-collapse-1" style="margin-top:8px;">
              ...
              <ul class="nav navbar-nav">
                     <li>
                         <a href="home_page_edit_profile.jsp"> <h3 class="navigation_heading" > <span class="glyphicon glyphicon-user"></span> &nbsp;Welcome&nbsp;  <b> <%=session.getAttribute("user")%></b></h3> </a>
                    </li>     
 ...
 <!--									<span class="badge">4+</span>
		                ...
		                <div class="list-group marginedit" style="margin-bottom:18px;">
		                    <a href="home_page_edit_profile.jsp" class="list-group-item active" style="height:35px;">
		                    	Edit Profile &nbsp;&nbsp;
                 ...
                 <div id="carousel-example-generic" class="carousel slide" data-ride="carousel" data-interval="3000">
							  ...
							  <div class="carousel-inner">
							    <div class="item active">
							      <img src="images/cop-home-2.jpg" alt="...">
							      <div class="carousel-caption">
							      	<h3 style="font-size:30px;">Pearson Claim Management System</h3>
							      </div>
							    </div>
							    <div class="item">
							      <img src="images/serandib-leisure-tilt-fishing.jpg" alt="...">
							      <div class="carousel-caption">
							      	<h3 style="font-size:30px;">Pearson Claim Management System</h3>
							      </div>
							    </div>
							    <div class="item">
							      <img src="images/cop-home-1.jpg" alt="...">
							      <div class="carousel-caption">
							      	<h3 style="font-size:30px;">Pearson Claim Management System</h3>
							      </div>
							    </div>
